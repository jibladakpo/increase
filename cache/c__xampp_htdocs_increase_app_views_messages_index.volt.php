...
<table class='table table-condensed table-hover'>
	<thead><tr><th colspan='3'><?php echo $model; ?></th></tr></thead>
		...
		<?php foreach ($objects as $object) { ?>
			<tr data-ajax="<?php echo $object->getId(); ?>">
			<td><?php echo $object->toString(); ?></td>
			<td class='td-center'><a class='btn btn-primary btn-xs update' href='<?php echo $this->url->get($baseHref . '/frmUpdate/' . $object->getId()); ?>' data-ajax="<?php echo $baseHref . '/frmUpdate/' . $object->getId(); ?>"><span class='glyphicon glyphicon-edit' aria-hidden='true'></span></a></td>
